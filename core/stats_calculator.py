...
class WaterPlotCalculator(StatsCalculator):
    ...
    def __init__(self):
        ...
        self.legend = {
            1: {"label": "60 % - 100 %", "color": (0,128,0), "range": (0.6, 1)},
            2: {"label": "40 % - 60 %", "color": (144,238,144), "range": (0.4, 0.6)},
            3: {"label": "30 % - 40 %", "color": (255,255,116), "range": (0.3, 0.4)},
            4: {"label": "10 % - 30 %", "color": (255,179,34), "range": (0.1, 0.3)},
            5: {"label": "-20 % - 10 %", "color": (215,25,28), "range": (-0.2, 0.1)}
